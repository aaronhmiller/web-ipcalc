...
<tr>
<td valign="top">&nbsp;</td>
<td><a href="http://jodies.de/ipcalc"><img src="http://jodies.de/ipcal03.gif" align=right width=100 height=95 border=0 alt=""></a></td></tr>
</table>
EOF
if ($help) {
print << "EOF";
...
<table border=0 width="100%" cellspacing=10>
 <tr>
  ...
  <td nowrap valign=top>
   ...
   <img src="http://jodies.de/ipcalculator.png" alt="Thanks to http://www.netzwerkinfo.de/daemons/ for this ip calculator icon :-)" border=0></a><br>
